...
def create_pmatrix_dicts(pmatrix_file, big_map=False, simple_sort=False):
    '''
    ...
    Args:
        ...
        big_map: if True, sort based on naming convention of the big map frame files
        simple_sort: if True, just sort by filename
